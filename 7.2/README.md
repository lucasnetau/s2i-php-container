...
The RHEL image is available in the [Red Hat Container Catalog](https://access.redhat.com/containers/#/registry.access.redhat.com/rhscl/php-72-rhel7)
as registry.access.redhat.com/rhscl/php-72-rhel7.
The CentOS image is then available on [Docker Hub](https://hub.docker.com/r/centos/php-72-centos7/)
...
PHP 7.2 available as docker container is a base platform for
...
* **INCLUDE_PATH**
  ...
  * Default: .:/opt/app-root/src:/opt/rh/rh-php72/root/usr/share/pear
* **SESSION_PATH**
